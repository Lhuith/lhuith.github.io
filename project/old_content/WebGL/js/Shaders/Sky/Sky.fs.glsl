...
void main()
{
	...
	float colorLerp=normalize(sin(1.));
	
	vec4 backgroundcol=vec4(1.,1.,.835,1.);
	vec4 dayColor=vec4(.027,.509,.929,1.);
	
	vec3 color=vec3(random(ipos,a/3.),random(ipos,a/1.5),random(ipos,a/2.));
