...
void main()
{
	...
	vec4 mainAtmoColor=vec4((colorlight.r/255.),(colorlight.g/255.),(colorlight.b/255.),1.);
	
	vec4 NoonStartColor=vec4(colordark.r/255.,colordark.g/255.,colordark.b/255.,1.);
	
	vec2 gradientLevel=vec2((angleIncidence),0.);
