...
import { WelcomeImage } from "../../../import";
...
export const buildWelcomeLevel = function (THREE) {
  ...
  let spriteSheet = new THREE.TextureLoader().load(WelcomeImage);
  ...
  welcome.initViewer(1.25, 3, 0, "o");
  if (!isMobile()) {
    welcome.updateCameraZoom(100);
  } else {
    welcome.updateCameraZoom(80);
  }
